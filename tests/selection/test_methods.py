...
@pytest.mark.parametrize("preselected_genes",
                         [['IL7R', 'CD14', 'NKG7'],
                          ['IL7R', 'CD14']])
@pytest.mark.parametrize("prior_genes",
                         [['LST1', 'CST3'],
                          ['CD14', 'NKG7']])
...
@pytest.mark.parametrize("marker_list",
                         [
                             "data/pbmc3k_marker_list.csv",
                             {
                                 "CD4 T cells": ["IL7R"],
...
def test_selection_stable(adata_pbmc3k):
    ...
    selector_a = se.ProbesetSelector(adata_pbmc3k[idx, :], verbosity=2, n=50, celltype_key="celltype",
    ...
    selector_b = se.ProbesetSelector(adata_pbmc3k[idx, :], verbosity=2, n=50, celltype_key="celltype",
                                     seed=0, save_dir=None,
                                     forest_hparams={"n_trees": 10, "subsample": 200, "test_subsample": 400})
...
@pytest.mark.parametrize("n, "
                         ...
                         "reference_selections", [
                             (10, "highly_variable", [0, 202], 0, None, {
...
def test_select_reference_probesets(adata_pbmc3k,
                                    n,
                                    geney_key,
                                    seeds,
                                    verbosity,
                                    save_dir,
                                    request, reference_selections):
    se.select_reference_probesets(adata_pbmc3k,
                                  n=n,
                                  genes_key="highly_variable",
                                  seeds=seeds,
                                  verbosity=verbosity,
